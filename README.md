...
**This app is using Rails 7.2.1 and Ruby 3.3.4**. The screenshot doesn't get
...
```sh
git clone https://github.com/nickjj/docker-rails-example joornal
cd joornal
...
The app is named `joornal` right now but chances are your app will be a different
name. Since the app is already created we'll need to do a find / replace on a
few variants of the string "joornal" and update a few Docker related resources.
